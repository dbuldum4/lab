...
export const THEMES = [
  ...
  },
  {
    id: "flexoki-light",
    label: "Flexoki Light",
    detail: "Inky tones on warm paper",
    colorScheme: "light",
    swatches: ["#fffcf0", "#205ea6", "#100f0f"],
  },
  {
    id: "ayu-light",
    label: "Ayu Light",
    detail: "Clean white and amber theme",
    colorScheme: "light",
    swatches: ["#fcfcfc", "#ff9940", "#5c6773"],
  },
  {
    id: "github-light-default",
    label: "GitHub Light Default",
    detail: "Familiar neutral developer theme",
    colorScheme: "light",
  ...
  },
  {
    id: "light-owl",
    label: "Light Owl",
    detail: "Accessible cool daylight theme",
    colorScheme: "light",
    swatches: ["#fbfbfb", "#4876d6", "#403f53"],
  },
  {
    id: "catppuccin-latte",
    label: "Catppuccin Latte",
    detail: "Soft pastel light theme",
    colorScheme: "light",
  ...
  },
  {
    ...
    detail: "Low-contrast cream theme",
    colorScheme: "light",
  ...
  },
  {
    ...
    detail: "Soft cream and forest theme",
    colorScheme: "light",
    swatches: ["#fdf6e3", "#8da101", "#5c6a72"],
  },
  {
    id: "kanagawa-lotus",
    label: "Kanagawa Lotus",
    detail: "Warm parchment and blue theme",
    colorScheme: "light",
    swatches: ["#f2ecbc", "#4d699b", "#545464"],
  },
  {
    id: "tokyo-night-day",
    label: "Tokyo Night Day",
    detail: "Cool modern daylight theme",
    colorScheme: "light",
    swatches: ["#e1e2e7", "#2e7de9", "#3760bf"],
  },
] as const;
